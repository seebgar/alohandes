...
ALTER TABLE HOSTELES MODIFY REGISTRO_CAMARA_COMERCIO VARCHAR(200) NOT NULL;
ALTER TABLE HOSTELES MODIFY REGISTRO_SUPERINTENDENCIA VARCHAR(200) NOT NULL;
...
ALTER TABLE PERSONAS MODIFY COSTO_MULTA FLOAT DEFAULT 0.0;

ALTER TABLE RESERVAS ADD ID_COLECTIVO INT;

ALTER TABLE PROPUESTAS ADD CAPACIDAD_MAXIMA INTEGER;
ALTER TABLE PROPUESTAS ADD DISPONIBLE INTEGER;
ALTER TABLE PROPUESTAS ADD FECHA_INICIO_DISPONIBILIDAD VARCHAR(25);
ALTER TABLE PROPUESTAS ADD FECHA_FINAL_DISPONIBILIDAD VARCHAR(25);
ALTER TABLE PROPUESTAS ADD CANTIDAD_DIAS_DISPONIBLE INT DEFAULT 0;
