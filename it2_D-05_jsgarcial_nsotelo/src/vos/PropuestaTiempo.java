...
public class PropuestaTiempo 
{
	 ...
	 * @param sub_total
	 */
	public PropuestaTiempo ( @JsonProperty(value="id") Long id,
			...
			@JsonProperty(value="sub_total") Double sub_total,@JsonProperty(value="tiempo") String tiempo ) {
		this.id = id;
